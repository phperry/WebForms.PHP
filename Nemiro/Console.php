...
namespace Nemiro
{
	...
	class Console
	{
		 ...
		 * @return void
		 */
		public static function Log($msg, $arg = NULL, ...$args)
		{
			if (!\Nemiro\App::$Debug) { return; }
			\Nemiro\Console::$LogItems[] = array('log', $msg, $arg, $args);
		}
		 ...
		 * @return void
		 */
		public static function Error($msg, $arg = NULL, ...$args)
		{
			if (!\Nemiro\App::$Debug) { return; }
			\Nemiro\Console::$LogItems[] = array('error', $msg, $arg, $args);
		}
		 ...
		 * @return void
		 */
		public static function Info($msg, $arg = NULL, ...$args)
		{
			if (!\Nemiro\App::$Debug) { return; }
			\Nemiro\Console::$LogItems[] = array('info', $msg, $arg, $args);
		}
		 ...
		 * @return void
		 */
		public static function Warning($msg, $arg = NULL, ...$args)
		{
			if (!\Nemiro\App::$Debug) { return; }
			\Nemiro\Console::$LogItems[] = array('warn', $msg, $arg, $args);
		}
